...
const ProductForm = ({fetchData}) => {
    ...
    const handleUpdateProductFormValues = (value, inputReference) => {
        ...
        if(inputReference === 'descripcion'){
            setProductFormValues((prevState=>({...prevState, descripcion: value})))
        }
        if(inputReference === 'descripcionLarga'){
            setProductFormValues((prevState=>({...prevState, descripcionLarga: value})))
        }
    }
    ...
    <div>
        <form id="formulario">
            ...
            <div className="grupo" id="grupo-descrip-corta">
                ...
                <textarea className="formFields" onChange={(e) => handleUpdateProductFormValues(e.target.value, descripcion )} id="descrip-corta" name="descrip-corta" rows="3" required></textarea>
            ...
            <div className="grupo" id="grupo-descrip-larga">
                ...
                <textarea className="formFields" onChange={(e) => handleUpdateProductFormValues(e.target.value, descripcionLarga )} id="descrip-larga" name="descrip-larga" rows="6" required></textarea>
